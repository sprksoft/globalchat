...
pub fn stage() -> AdHoc {
    AdHoc::on_ignite("metrics", async |r| {
        let lmetrics = LMetrics::new(&[
            ...
            &crate::endpoints::gcagent::messages_total::METRIC,
            &crate::endpoints::gcagent::messages_blocked::METRIC,
            &crate::endpoints::gcagent::total_connections_by_seconds::METRIC,
            &crate::endpoints::gcagent::total_connections_waiting_millis::METRIC,
