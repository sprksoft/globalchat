...
#[inline]
pub fn matches(sentence: &str, check: &str) -> bool {
...
pub fn sentence_contains_tree(tree: &StringTree, sentence: &str) -> bool {
    let mut index = 0;
...
pub fn sentence_contains_loop(wordlist: &Vec<Box<str>>, sentence: &str) -> bool {
    let sentence = sentence.to_lowercase();
...
impl STProfanityFilter {
    ...
    pub fn contains_profanity(&self, string: &str) -> bool {
        sentence_contains_tree(&self.tree, string)
    }
}
